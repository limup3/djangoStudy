    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='groupbusinesscard', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': '그룹 명함첩',
